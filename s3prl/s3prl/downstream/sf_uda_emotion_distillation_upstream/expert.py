...
class DownstreamExpert(nn.Module):
    ...
    def generate_pseudo_labels(self, features):
        ...
        with torch.no_grad():
            ...
            logits, _, _ = self.model(features, None)
    ...
    # ------------------------------------------------
    def forward(self, mode, features, labels, filenames, records, addi_features, global_step, args, **kwargs):
        """
        Single forward pass. 
        ...
        if mode == 'train':
            ...
            # Student predictions
            student_logits, _, _ = self.model(features, features_len)
            ...
            # records.setdefault('hamming_acc', []).append(hamming_acc)
    ...
    def log_records(self, mode, records, logger, global_step, **kwargs):
        ...
        # log acc & loss
        for key in ["acc", "ham_acc", "loss", "distill", "diversity", "entropy", "fbnm"]: #"nuclear_norm"]:
            values = records[key]
